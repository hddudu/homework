...
public class ArgsAspect {
	...
	@Pointcut("execution(* com.hongdu.spring.aop.service..*(..))")
	public void aspect(){	}
	
	//配置前置通知,拦截返回值为com.gupaoedu.vip.model.Member的方法
	@Before("execution(com.hongdu.spring.model.Member com.hongdu.spring.aop.service..*(..))")
	public void beforeReturnUser(JoinPoint joinPoint){
		log.info("beforeReturnUser " + joinPoint);
	}

	//配置前置通知,拦截参数为com.gupaoedu.vip.model.Member的方法
	@Before("execution(* com.hongdu.spring.aop.service..*(com.hongdu.spring.model.Member))")
