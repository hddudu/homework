...
<script src="${pageContext.request.contextPath}/resources/static/js/index/article_pub.js" type="text/javascript"></script>
      ...
      <ul class="layui-nav layui-nav-left" lay-filter="filter">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            <dd class="layui-this"><a href="article_pub.jsp">文章发布</a></dd>
